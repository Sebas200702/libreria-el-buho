...
type Row = [title: string, author: string, price: number, genre: string, category?: string];

// [title, author, price_cop, genre, category?]
const BOOKS: Row[] = [
  ['El principito', 'Antoine de Saint-Exupéry', 16000, 'Infantil', 'Fábula'],
  ['Cien años de soledad', 'Gabriel García Márquez', 16000, 'Literatura colombiana', 'Novela'],
  ['Harry Potter y la piedra filosofal', 'J.K. Rowling', 21000, 'Fantasía', 'Novela'],
  ['Harry Potter y el cáliz de fuego', 'J.K. Rowling', 23000, 'Fantasía', 'Novela'],
  ['Harry Potter y el prisionero de Azkabán', 'J.K. Rowling', 21000, 'Fantasía', 'Novela'],
  ['Crimen y castigo', 'Fiódor Dostoievski', 21000, 'Literatura rusa', 'Novela'],
  ...
  ['Rebelión en la granja', 'George Orwell', 18000, 'Ficción clásica', 'Novela'],
  ['Cómo ganar amigos e influir en los demás', 'Dale Carnegie', 18000, 'Desarrollo personal'],
  ['El hombre más rico de Babilonia', 'George S. Clason', 18000, 'Desarrollo personal'],
  ...
  ['Los hermanos Karamázov', 'Fiódor Dostoievski', 23000, 'Literatura rusa', 'Novela'],
  ['El idiota', 'Fiódor Dostoievski', 21000, 'Literatura rusa', 'Novela'],
  ['Memorias del subsuelo', 'Fiódor Dostoievski', 21000, 'Literatura rusa', 'Novela'],
  ['Fausto', 'Johann Wolfgang von Goethe', 21000, 'Teatro', 'Drama'],
  ['El llamado de la selva', 'Jack London', 18000, 'Ficción clásica', 'Aventura'],
  ['Un mundo feliz', 'Aldous Huxley', 18000, 'Ficción clásica', 'Distopía'],
  ['Alicia en el país de las maravillas', 'Lewis Carroll', 16000, 'Infantil', 'Fantasía'],
  ...
  ['La cabaña del tío Tom', 'Harriet Beecher Stowe', 21000, 'Ficción clásica', 'Novela'],
  ...
  ['El contrato social', 'Jean-Jacques Rousseau', 18000, 'Filosofía', 'Política'],
  ['Discurso del método', 'René Descartes', 15000, 'Filosofía'],
  ['Utopía', 'Tomás Moro', 18000, 'Filosofía'],
  ['Los viajes de Gulliver', 'Jonathan Swift', 18000, 'Ficción clásica', 'Sátira'],
  ['La vuelta al mundo en 80 días', 'Julio Verne', 18000, 'Ficción clásica', 'Aventura'],
  ['De la Tierra a la Luna', 'Julio Verne', 17000, 'Ficción clásica', 'Ciencia ficción'],
  ['El capitán de quince años', 'Julio Verne', 17000, 'Ficción clásica', 'Aventura'],
  ['El faro del fin del mundo', 'Julio Verne', 17000, 'Ficción clásica', 'Aventura'],
  ...
  ['Cartas al padre', 'Franz Kafka', 15000, 'Ficción clásica', 'Correspondencia'],
  ...
  ['El malestar en la cultura', 'Sigmund Freud', 18000, 'Filosofía', 'Psicoanálisis'],
  ...
  ['Del sentimiento trágico de la vida', 'Miguel de Unamuno', 15000, 'Filosofía'],
  ['Niebla', 'Miguel de Unamuno', 15000, 'Ficción clásica', 'Novela'],
  ['Ajuste de cuentas', 'John Grisham', 17000, 'Ficción contemporánea', 'Thriller'],
  ['Legítima defensa', 'John Grisham', 17000, 'Ficción contemporánea', 'Thriller'],
  ['Causa justa', 'John Grisham', 17000, 'Ficción contemporánea', 'Thriller'],
  ['El símbolo perdido', 'Dan Brown', 18000, 'Ficción contemporánea', 'Thriller'],
  ...
  ['Novelas ejemplares', 'Miguel de Cervantes', 18000, 'Ficción clásica', 'Cuentos'],
  ['Los cuadernos de don Rigoberto', 'Mario Vargas Llosa', 23000, 'Literatura latinoamericana', 'Novela'],
  ['El honor perdido de Katharina Blum', 'Heinrich Böll', 18000, 'Ficción clásica', 'Novela'],
  ['El enigmático Mr. Quin', 'Agatha Christie', 17000, 'Ficción contemporánea', 'Misterio'],
  ...
  ['Qué es una Constitución', 'Ferdinand Lassalle', 15000, 'Ensayo', 'Política'],
  ['Los bienes terrenales del hombre', 'Leo Huberman', 17000, 'Ensayo', 'Economía'],
  ...
  ['La máquina del tiempo', 'H.G. Wells', 17000, 'Ficción clásica', 'Ciencia ficción'],
  ['El hombre invisible', 'H.G. Wells', 17000, 'Ficción clásica', 'Ciencia ficción'],
  ['Azul', 'Rubén Darío', 15000, 'Poesía'],
  ['Blue Period', 'Tsubasa Yamaguchi', 18000, 'Ficción contemporánea', 'Manga'],
  ['Los viajes de Marco Polo', 'Marco Polo', 15000, 'Ensayo', 'Crónica de viaje'],
  ['El hombre mediocre', 'José Ingenieros', 18000, 'Ensayo'],
  ['Los de abajo', 'Mariano Azuela', 18000, 'Literatura latinoamericana', 'Novela'],
  ...
  ['El amor, las mujeres y la muerte', 'Arthur Schopenhauer', 15000, 'Filosofía'],
  ['No violencia', 'Mark Kurlansky', 15000, 'Ensayo'],
  ['Frutos de mi tierra', 'Tomás Carrasquilla', 18000, 'Literatura colombiana', 'Novela'],
  ['La marquesa de Yolombó', 'Tomás Carrasquilla', 18000, 'Literatura colombiana', 'Novela'],
  ['Cuentos', 'Tomás Carrasquilla', 15000, 'Literatura colombiana', 'Cuentos'],
  ['De sobremesa', 'José Asunción Silva', 18000, 'Literatura colombiana', 'Novela'],
  ['Manuela', 'Eugenio Díaz Castro', 18000, 'Literatura colombiana', 'Novela'],
  ['El carnero', 'Juan Rodríguez Freyle', 18000, 'Literatura colombiana', 'Crónica'],
  ['Cumandá', 'Juan León Mera', 17000, 'Literatura latinoamericana', 'Novela'],
  ['Sin tetas no hay paraíso', 'Gustavo Bolívar', 18000, 'Literatura colombiana', 'Novela'],
  ...
  ['Los monstruos y los críticos', 'J.R.R. Tolkien', 17000, 'Ensayo', 'Literario'],
  ['Una rosa para Emily y otros cuentos', 'William Faulkner', 17000, 'Ficción clásica', 'Cuentos'],
  ['Cuentos', 'Alejo Carpentier', 15000, 'Literatura latinoamericana', 'Cuentos'],
  ...
  ['El alcalde de Zalamea', 'Pedro Calderón de la Barca', 17000, 'Teatro', 'Drama'],
  ['Historia de la vida del Buscón', 'Francisco de Quevedo', 17000, 'Ficción clásica', 'Novela'],
  ['El sombrero de tres picos', 'Pedro Antonio de Alarcón', 15000, 'Ficción clásica', 'Novela'],
  ['Cartas desde mi molino', 'Alphonse Daudet', 15000, 'Ficción clásica', 'Cuentos'],
  ...
  ['Parménides y Heráclito: fragmentos', 'Parménides / Heráclito', 15000, 'Filosofía'],
  ['Los nibelungos', 'Anónimo', 21000, 'Ficción clásica', 'Épica'],
  ['Teogonía', 'Hesíodo', 15000, 'Filosofía', 'Mito'],
  ['El imperialismo, fase superior del capitalismo', 'Vladimir Lenin', 15000, 'Ensayo', 'Política'],
  ...
  ['Cómo el hombre llegó a ser grande', 'Mijaíl Ilin', 16000, 'Ensayo', 'Ciencia'],
  ['Mi amigo el pintor', 'Lygia Bojunga', 16000, 'Infantil'],
  ['Antología de poetas colombianos', 'Varios', 12000, 'Literatura colombiana', 'Poesía'],
  ...
  ['Los misterios de Alejandro Magno', 'Paul Doherty', 16000, 'Ficción contemporánea', 'Histórica'],
  ['La máscara de Ra', 'Paul Doherty', 16000, 'Ficción contemporánea', 'Histórica'],
  ['Osceola, el gran jefe de los seminolas', 'Mayne Reid', 16000, 'Ficción clásica', 'Aventura'],
  ...
  ['El despertar de la gracia del mundo de carne', 'Varios', 12000, 'Ficción clásica'],
  ...
  ['La sangre de los inocentes', 'Varios', 12000, 'Ficción contemporánea', 'Thriller'],
  ...
  ['El monasterio maldito', 'Varios', 12000, 'Ficción contemporánea', 'Misterio'],
  ...
  ['El mundo, la carne y el padre Smith', 'Bruce Marshall', 16000, 'Ficción clásica', 'Novela'],
];
...
async function fetchCoverOpenLibrary(title: string, author: string): Promise<string | null> {
  try {
    ...
    if (!r.ok) return null;
    const data = (await r.json()) as { docs?: Array<{ cover_i?: number; cover_edition_key?: string }> };
...
async function fetchCoverGoogleBooks(title: string, author: string): Promise<string | null> {
...
async function seedBooks() {
  console.log(`→ Seeding ${BOOKS.length} books (pulling covers from Google Books)…`);
...
async function wipeOldBooks() {
  ...
  else console.log(`→ Cleared ${oldSlugs.length} placeholder books from previous seed.`);
}
